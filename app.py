...
params = urllib.parse.quote_plus(
    "DRIVER={ODBC Driver 17 for SQL Server};SERVER=demotoday.database.windows.net;DATABASE=demotsg;UID=admindemo;PWD=123456aA@")
cnxn = pyodbc.connect(
    "Driver={ODBC Driver 17 for SQL Server};Server=demotoday.database.windows.net,1433;Database=demotsg;Uid=admindemo;Pwd=123456aA@;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;")
